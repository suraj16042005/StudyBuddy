...
function showEnrollmentModal(course, mentor) {
    ...
    // Reset modal state
    document.getElementById('enrollmentStep')?.style.display = 'block';
    document.getElementById('enrollmentSuccess')?.style.display = 'none';
    document.getElementById('enrollment-footer')?.style.display = 'flex'; // Show footer actions
...
confirmEnrollmentBtn?.addEventListener('click', async () => {
    ...
    try {
        ...
        document.getElementById('enrollment-footer')?.style.display = 'none'; // Hide footer actions
